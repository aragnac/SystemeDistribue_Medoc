...
<head>
    ...
    <meta property="og:description"
          content="Split is a centrally-divided layout for a professional online presence with a big image or video left with alongside content."/>
    <meta property="og:image"
          content="https://demo.onepagelove.com/fullsingle-html/split/images/social.jpg">
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="/applicationPatientWEB/CSS/split.css" type="text/css"
          media="screen"/>
...
<div class="fs-split">
    ...
    <div class="split-content">
        <div class="split-content-vertically-center">
            ...
            <div class="split-bio">
                <p>Consultez vos résultats d'analyse rapidement et facilement en un seul clic. Vous
                    pouvez également éffectuer le paiement facilement à l'aide de payPal. </p>
                <form action="/applicationPatientWEB/Main" method="post">
                    Entrez votre numéro de demande :<br>
                    <input type="text" style="text-align:center;" align="center" name="numDemande"
                           value=""><br><br>
                    <input id="type" type="hidden" name="type" value="resultats">
                    <input type="submit" style="text-align:center;" align="center"
                           value="Obtenir Résultats">
                </form>
                ...
                <script>
                    paypal.Button.render({
                        ...
                        payment: function () {
                            ...
                            var CREATE_URL = 'http://aragnac.pythonanywhere.com/create';
                        ...
                        onAuthorize: function (data, actions) {
                            ...
                            var EXECUTE_URL = 'http://aragnac.pythonanywhere.com/execute';
            ...
            <div class="split-credit">
                <p>&copy;2017 <a href="#">BNSF@Lab</a> - <a href="https://onepagelove.com/split">Split
                    Template</a> by <a href="https://onepagelove.com">One Page Love</a></p>
